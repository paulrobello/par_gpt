...
class UpdateDepsCommand(BaseCommand):
    ...
    def execute(
        ...
        self.console.print("[yellow]Dependency update functionality not fully available due to import restrictions[/yellow]")
...
def create_update_deps_command():
    ...
    def update_deps_command(
        ...
        skip_packages: Annotated[list[str] | None, typer.Option("--skip", "-s", help="Additional packages to skip during update")] = None,
    ) -> None:
...
def create_publish_repo_command():
    ...
    def publish_repo_command(
        ctx: typer.Context,
        repo_name: Annotated[str | None, typer.Option("--repo-name", "-r", help="Name of the repository. (Defaults to repo root folder name)")] = None,
...
def create_tinify_command():
    ...
    def tinify_command(
        ...
        output_file: Annotated[str | None, typer.Option("--output-image", "-o", help="File to save compressed image to. Defaults to image_file.")] = None,
    ) -> None:
...
def create_pi_profile_command():
    ...
    def pi_profile_command(
        ...
        modules: Annotated[list[str] | None, typer.Option("--module", "-m", help="Module to include in analysis. Can be specified more than once.")] = None,
        output: Annotated[str | None, typer.Option("--output", "-o", help="File to save markdown to. Defaults to screen.")] = None,
